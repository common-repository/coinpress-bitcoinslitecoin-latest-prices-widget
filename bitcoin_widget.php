<?php
/*
    Plugin Name: Bitcoin Prices Ticker Widget
    ...
    Author: Suumit Shah
    Version: 1.0
    Author URI: suumit@buybitcoinspaypal.com
*/
...
class Bitcoin_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$show = (esc_attr($instance['show']) == '1') ? true : 2;
...
<div id='bitcoin-widget-<?php echo $btw_widget_index; ?>'>
	<div id="bitcoin-widget" class='bitcoin-widget'>
        ...
        <div class="bitcoin-link-row">
			...
			<?php
				if($show==1) {?>
		   		 	<div class="bitcoin-link-row">
						<span class="bitcoin-last-powered"><a href="http://buybitcoinspaypal.com/">BuyBitcoinsPayPal.com</a></span>
					</div>
			<?php } ?>			
	</div>
</div>
	...
	?>	
		<div>
			...
			<h4 class="bt-tab-head">Credit Where Credit is Due</h4>
			<table class="bt-table">
				<tr>
					<td></td>
					<td>Show</td>
				...
				<tr>
					<td>Author Credits</td>
						<td><input type="radio" id="<?php echo $this->get_field_id('show'); ?>" name="<?php echo $this->get_field_name('show');?>" <?php if($show!='' && $show=='1') echo "checked" ;?> value="1"/></td>
					<td><input type="radio" id="<?php echo $this->get_field_id('show'); ?>" name="<?php echo $this->get_field_name('show');?>" <?php if($show!='' && $show=='2') echo "checked" ;?> value="2" /></td>
					</tr>
			</table>
